...
## Steps for execution:
  ...
  #### 6. Type 'iverilog -o <testfile_name> <source_file.v> <other_source_or_dependent_files.v', in the command prompt; (say, 'iverilog -o test and2.v') (say, the files names is 'and2.v').
